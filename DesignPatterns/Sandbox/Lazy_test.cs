...
namespace DesignPatterns
{
    public class Lazy_test
    {
        public static void Run(SqlConnector SqlConn)
        {
            ...
            var lazyMe = new Lazyload<ActiveRecord<Person>>(id, SqlConn);
            ...
            // FIXME
            var lazyYou = new Lazyload<DataMapper<Person>>(SqlConn);
            Console.WriteLine(lazyYou["Count"]);
            DataMapper<Person> lazyMapper = lazyYou.GetObject();
