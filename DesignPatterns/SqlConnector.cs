...
namespace DesignPatterns
{
    public class SqlConnector
    {
        ...
        private readonly string NOTNULL = " NOT NULL, ";
        ...
        public void CreateTable<T>(bool DoClearDB)
        {
            ...
            foreach (var property in properties)
            {
                ...
                string tmp = ", ";
                var customAttributes = property.GetCustomAttributes(typeof(NullableColumnAttribute), false);
                if (customAttributes.Length > 0)
                {
                    NullableColumnAttribute columnAttribute = (NullableColumnAttribute)customAttributes[0];
